...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: "image", title: "Image de carte", type: "mediaItem", group: "media" }),
    defineField({ name: "heroImage", title: "Image hero", type: "mediaItem", group: "media" }),
      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({ name: "image", title: "Image", type: "mediaItem" }),
