...
export function VideoSection() {
  ...
  return (
    <section className="section-divider relative overflow-hidden bg-[#090909] py-12 md:py-18">
      ...
      <div className="section-shell">
        <Reveal>
          <div className="max-w-3xl">
            ...
            <h2 className="section-title mt-3 text-[clamp(2.6rem,6vw,5.6rem)]">{video.title}</h2>
        ...
        <div className="mt-7 grid gap-4 md:grid-cols-3 md:gap-5">
          {video.videos.map((item, index) => (
            <Reveal key={item.title} delay={0.05 * index}>
              <div className="editorial-panel p-3 md:p-4">
                <div className="group media-cut relative overflow-hidden border border-white/10 bg-black">
                  <img
                    src={item.poster}
                    alt={item.title}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="flex h-[4.5rem] w-[4.5rem] items-center justify-center border border-white/18 bg-black/[0.45] backdrop-blur-md transition group-hover:scale-105 md:h-20 md:w-20">
                  ...
                  <div className="absolute inset-x-4 bottom-4 flex items-end justify-between gap-3 md:inset-x-5 md:bottom-5">
                    ...
                    <div className="border border-white/15 bg-black/35 p-2.5 backdrop-blur-sm md:p-3">
